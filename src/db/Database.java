...
public class Database {
    public static ArrayList <Vehicle> vehicleTable = new ArrayList<>();
    ...
    static {
        ...
        driverTable.add(
                new Driver("Amila Pathirana", "8826253734V", "B3354674", "Galle", "0717573583")
        );
        driverTable.add(
                new Driver("Jithmal Perera", "9283289272V", "B3674589", "Horana", "0772452457")
        );
        driverTable.add(
                new Driver("Sumith Dissanayaka", "9425245373V", "B8366399", "Kaluthara", "0782686390")
        );
        driverTable.add(
        ...
        driverTable.add(
                new Driver("Dineth Udara", "9026344373V", "B5343783", "Hettimulla", "0713456878")
        );
        driverTable.add(
        ...
        driverTable.add(
                new Driver("Priyanga Perera", "9135343537V", "B3853753", "Matara", "0723344562")
        );
    }
    ...
    public static ArrayList<Deliver> deliveryTable = new ArrayList<Deliver>();
    static {
